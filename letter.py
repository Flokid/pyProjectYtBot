class Menu():
    ...
    get_back_all_video_in_yasisk = "Видео загружено!"
    decide = "Выберите куда загрузить видео с канала:"

    get_token = "Дайте токен вашего яндекс диска.\n Как его получить можете узнать по этой ссылке ↓\n " \
